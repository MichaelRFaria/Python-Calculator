...
button_add=Button(root,text="+",padx=39,pady=20,command=button_add,bg="gray")
button_equal=Button(root,text="=",padx=91,pady=20,command=button_equal,bg="gray")
button_clear=Button(root,text="Clear",padx=79,pady=20,command=button_clear,bg="gray")

button_subtract=Button(root,text="-",padx=41,pady=20,command=button_subtract,bg="gray")
button_multiply=Button(root,text="*",padx=40,pady=20,command=button_multiply,bg="gray")
button_divide=Button(root,text="/",padx=41,pady=20,command=button_divide,bg="gray")
